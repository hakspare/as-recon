...
def logo():
    # স্ট্রিংয়ের আগে 'fr' যোগ করা হয়েছে যা SyntaxWarning চিরতরে বন্ধ করবে
    print(fr"""
...
def check_status(url):
    try:
        # ৫ সেকেন্ড টাইমআউট রাখা হয়েছে যাতে টুলটি ফাস্ট থাকে
...
def run_recon():
    ...
    try:
        # সাবফাইন্ডার এবং গাউ রান করা হচ্ছে
        ...
        # মাল্টি-থ্রেডিং ইঞ্জিন (রকেট স্পিড)
        results = []
